...
```{r, eval=FALSE}
# 
dataSet<-CreateMirNets("mir2gene");
...
PerformMirTargetEnrichAnalysis(adjust.type="NA", fun.type="kegg", file.nm="network_enrichment_kegg_1", IDs, algo="hyp")
```
